...
const FALLBACK_MODEL_ID = 'mistralai/mistral-7b-instruct:free'; // ИЗМЕНЕНО: Надежная резервная модель из нового списка
...
class NeuralCollaborativeFramework {
    ...
    initializeSettings() {
        this.settings = {
            model: 'GPT-3.5 Turbo (free) - 16385 токенов', // ИЗМЕНЕНО: Надежная бесплатная модель по умолчанию из нового списка
            temperature: 0.7,
            max_tokens: 1500,
...
3. При необходимости, зайдите в "⚙️ Настройки" для выбора моделей, участников и т.д.
